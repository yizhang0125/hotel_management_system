...
$stmt = $pdo->prepare("SELECT b.*, r.room_type, r.price, r.room_number 
                       FROM bookings b
...
$total_price = $total_days * $booking['price'];
...
$pdf_link = "generate_pdf.php?booking_id=" . urlencode($booking_id);
?>
        ...
        <div class="card mb-4">
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <p><strong>Duration:</strong> <?= $total_days ?> nights</p>
